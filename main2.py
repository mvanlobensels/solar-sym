...
solar_system = PlanetarySystem([
    ...
    # CelestialBody(name='Moon',    mass=0.0123*Me, position=[1.002707*AU, 0], velocity=[0, 29290]),
    CelestialBody(name='Mars',    mass=0.107*Me,  position=[1.5*AU, 0],  velocity=[0, 24000]),
    CelestialBody(name='Jupiter', mass=2000*317.8*Me,  position=[5.2*AU, 0],  velocity=[0, 12440])
])
